...
"""
    ...
    def test_run_formatting(self):
        ...
        src = "pass"
        self.mktmp(src)
        _ip.magic(f'run -t -N 1 {self.fname}')
        _ip.magic(f'run -t -N 10 {self.fname}')
